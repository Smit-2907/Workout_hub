...
('Pull-Ups', 'The ultimate back and biceps builder. Grip the bar wider than shoulder-width and pull your chest to the bar.', 'Back', 'Advanced', 'https://www.youtube.com/watch?v=eGo4IYlbE5g', 'https://images.unsplash.com/photo-1598971639058-fab3c043bc6f?auto=format&fit=crop&q=80&w=800'),
('Dumbbell Shoulder Press', 'Build powerful shoulders. Sit upright and press the weights until arms are fully extended.', 'Shoulders', 'Intermediate', 'https://www.youtube.com/watch?v=qEwKCR5JCog', 'https://images.unsplash.com/photo-1541534741688-6078c64b5901?auto=format&fit=crop&q=80&w=800'),
('Plank', 'Core stability classic. Hold a straight line from head to heels.', 'Core', 'Beginner', 'https://www.youtube.com/watch?v=ASdvN_XEl_c', 'https://images.unsplash.com/photo-1566241142559-40e1bfc26cb4?auto=format&fit=crop&q=80&w=800'),
('Diamond Push-Ups', 'A variation of push-ups that targets the triceps and inner chest specifically. Form a diamond shape with your hands.', 'Chest', 'Intermediate', 'https://www.youtube.com/watch?v=J0DnG1_S92I', 'https://images.unsplash.com/photo-1599058917233-97f3b890aefd?auto=format&fit=crop&q=80&w=800'),
('Deadlifts', 'A powerhouse compound movement focusing on the entire posterior chain, including back and legs.', 'Back', 'Advanced', 'https://www.youtube.com/watch?v=op9kVnSso6Q', 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&q=80&w=800'),
('Lunges', 'Excellent for lower body balance and strength. Step forward and lower your hips until both knees are bent at about a 90-degree angle.', 'Legs', 'Beginner', 'https://www.youtube.com/watch?v=QOVaHwm-Q6U', 'https://images.unsplash.com/photo-1434608519344-49d77a699e1d?auto=format&fit=crop&q=80&w=800'),
